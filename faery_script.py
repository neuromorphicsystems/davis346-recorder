...
def wiggle(
    ...
    stream = faery.events_stream_from_file(input, dimensions_fallback=(346, 260)).time_slice(start=start, end=end)
...
job_manager.add(
    faery.dirname / "recordings" / "2025-08-03T20-22-46.823255Z.csv",
    "00:00:18.955136",
    "00:00:23.030661",
    tasks,
)
